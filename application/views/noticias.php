...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li ><a href="<?=base_url()?>index.php/slide"><i class="icon-dashboard"></i><span>Slide</span> </a> </li>
        <li class="active"><a href="<?=base_url()?>index.php/noticias"><i class="icon-list-alt"></i><span>Noticias</span> </a> </li>
              ...
              <form id="upload-file" class="form-horizontal" >
                  <fieldset>
                    ...
                    <div class="control-group">                     
                      <label class="control-label">Opciones a subir</label>
                      
                                            
                        <div class="controls">
                          <label class="radio inline">
                            <input value="pdf" checked class="opcion" type="radio" name="opcion"> Archivo PDF
                          </label>
                                            
                          <label class="radio inline">
                            <input value="url" class="opcion" type="radio" name="opcion"  > Direccion URL
                          </label>
                        </div>  <!-- /controls -->      
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span8" id="titulo" name="titulo" value="" placeholder="Titulo">
                    ...
                    <div class="control-group">                     
                      <label class="control-label" for="url">Direccion URL</label>
                      <div class="controls">
                        <input type="text" class="span8" disabled="disabled"  id="url" name="url" value="" placeholder="http://">
                    ...
                    <div class="control-group">                     
                      <label class="control-label" for="pdf">Archivo a subir</label>
                      <div class="controls">
                        <!-- <input type="file" name="file-id1" id="pdf-file" > -->
                    ...
                    <div class="control-group">                     
                      <label class="control-label" for="previa">Imagen de previsualización</label>
                      <div class="controls">
...
<script src="<?=base_url()?>recursos/js/jquery.form.js"></script>
<script src="<?=base_url()?>recursos/js/noticias-upload-app.js"></script>
